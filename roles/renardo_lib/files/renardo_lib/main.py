"""
    ...
    python main.py or python -m FoxDot if you have FoxDot correctly
...
from FoxDot.lib import FoxDotCode, handle_stdin
...
if args.pipe:
    ...
    if args.simple:
        ...
        from FoxDot.lib.Workspace.Simple import workspace
